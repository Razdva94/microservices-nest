...
exports.CreateTaskFieldDto = void 0;
const swagger_1 = require("@nestjs/swagger");
const client_1 = require("@prisma/client");
const class_validator_1 = require("class-validator");
class CreateTaskFieldDto {
}
exports.CreateTaskFieldDto = CreateTaskFieldDto;
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'Поле имени должно быть заполнено' }),
    (0, class_validator_1.IsString)({ message: 'Имя должно быть строкой' }),
    __metadata("design:type", String)
], CreateTaskFieldDto.prototype, "name", void 0);
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'Поле значения должно быть заполнено' }),
    __metadata("design:type", Object)
], CreateTaskFieldDto.prototype, "value", void 0);
//# sourceMappingURL=create-task-filed.dto.js.map